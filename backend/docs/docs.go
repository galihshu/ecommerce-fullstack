...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/protected/admin/dashboard/sales-chart": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/protected/checkout/orders/{id}/cancel": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "handlers.LoginRequest": {
            ...
            "properties": {
                ...
                "guest_cart": {
                    "description": "Array of guest cart items",
                    "type": "array",
                    "items": {
                        "type": "object",
                        "additionalProperties": true
        ...
        "models.Order": {
            ...
            "properties": {
                ...
                "payment_status": {
                    "description": "unpaid, paid, failed, refunded",
                    "type": "string"
                },
                "shipping_address": {
                    "type": "string"
